...
namespace WinFastGUI.Controls
{
    public partial class BloatwareCleanerUserControl : UserControl
    {
        ...
        {
            InitializeComponent();
            Loaded += BloatwareCleanerUserControl_Loaded;
        ...
        private void BloatwareCleanerUserControl_Loaded(object sender, RoutedEventArgs e)
        {
            LoadBloatwareList();
        ...
        public void UpdateLanguage()
        {
            ...
            TitleTextBlock.Text = WinFastGUI.Properties.Strings.BloatwareCleaner;
            SelectAllButton.Content = WinFastGUI.Properties.Strings.SelectAll;
            SelectRecommendedButton.Content = WinFastGUI.Properties.Strings.SelectRecommended;
            ClearSelectionButton.Content = WinFastGUI.Properties.Strings.ClearSelection;
            RemoveButton.Content = WinFastGUI.Properties.Strings.Remove;
            RemoveAllButton.Content = WinFastGUI.Properties.Strings.RemoveAll;
            RestoreButton.Content = WinFastGUI.Properties.Strings.Restore;
        }
